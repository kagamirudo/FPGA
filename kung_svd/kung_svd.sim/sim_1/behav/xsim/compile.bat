...
REM
REM Generated by Vivado on Tue Jul 29 07:55:20 -0400 2025
...
echo "xvhdl --incr --relax -prj tb_svd_array_vhdl.prj"
call xvhdl  --incr --relax -prj tb_svd_array_vhdl.prj -log xvhdl.log
