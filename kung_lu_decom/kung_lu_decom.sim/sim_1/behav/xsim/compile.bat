...
REM
REM Generated by Vivado on Tue Aug 05 09:12:38 -0400 2025
...
echo "xvhdl --incr --relax -prj lu_tb_vhdl.prj"
call xvhdl  --incr --relax -prj lu_tb_vhdl.prj -log xvhdl.log
